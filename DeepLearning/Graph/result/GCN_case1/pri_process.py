...
phys_names = [] #vtkに格納されているスカラーフィールド等のうち、npyで保存するもののリスト。ex) phys_names = ["Displacement_X"]
...
for dir in vtk_dir:
    ...
    以上より、"R"mmの結果を入力、"r"mmの結果を出力とする場合、ノード座標値に関しては入力に"x_interp_rmm_R_mm.npy"、出力に"x_rmm.npy"を用いればよい。
    """
    #####補間
