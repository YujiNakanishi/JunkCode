...
#####エッジ特徴量がe_ij = -e_jiとなるように、e_ji(j < i)を是としてe_ij = -e_jiと書き換え。 *そもそもモデルがe_ji = -e_jiを満たすような設計にするなど、改善の余地あり。
...
x_pred = bicgstab(coo_matrix(A), b, x0 = x_interp.flatten(), maxiter = 1000)[0]
